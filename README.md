...
<p align="center"><a href="https://app.flightledger.net"><b>Try it now at app.flightledger.net →</b></a></p>
...
| `npm run selftest` | 945 checks over distance, cost allocation, parsing and status math, plus a 500-case fuzz |
